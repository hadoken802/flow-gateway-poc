...
set FLOW_ACCOUNT_ID=FLOW-002
set AGENT_API_HOST=127.0.0.1
set AGENT_API_PORT=8112
set EXTENSION_WS_HOST=127.0.0.1
set EXTENSION_WS_PORT=9212
set FLOW_DB_PATH=D:\Codex\projects\flow_gateway_poc\data\FLOW-002.db
set OUTPUT_DIR=D:\Codex\projects\flow_gateway_poc\outputs\FLOW-002
